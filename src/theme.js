...
export const TYPE = {
  ...
  kpiValue:     { fontSize: 23, fontWeight: 600, letterSpacing: "-0.02em", lineHeight: 1.08, fontFamily: MONO, fontVariantNumeric: "tabular-nums" },
  ...
  tableMono:    { fontSize: 12, fontWeight: 500, lineHeight: 1.45, fontFamily: MONO, fontVariantNumeric: "tabular-nums" },
